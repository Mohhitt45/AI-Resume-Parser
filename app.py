...
BASE_URL = "https://mohhitt45-ai-resume-backend.hf.space"
...
if analyze:
    ...
    with st.spinner("Analyzing Resume..."):
        ...
        st.write("Hitting URL:", f"{BASE_URL}/match_resume")
...
if "result" in st.session_state and st.session_state["result"]:
    ...
    match_score = round(match_score * 100, 2) if match_score < 1 else match_score
...
if st.button("📄 Generate PDF Report"):
    ...
    if "result" not in st.session_state or not st.session_state["result"]:
        st.error("No data available. Please analyze resume first.")
        st.stop()

    file = create_report(st.session_state["result"])
